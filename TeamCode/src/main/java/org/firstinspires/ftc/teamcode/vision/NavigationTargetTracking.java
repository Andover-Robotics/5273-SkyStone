...
public class NavigationTargetTracking {
    // Camera Source.  Valid choices are:  BACK (behind screen) or FRONT (selfie side)
    // Phone Orientation. Choices are: PHONE_IS_PORTRAIT = true (portrait) or PHONE_IS_PORTRAIT = false (landscape)
    ...
    public NavigationTargetTracking(float phoneXRotate, float phoneYRotate, float phoneZRotate, Telemetry telemetry, HardwareMap hardwareMap) {
        this.phoneXRotate = phoneXRotate;
        this.phoneYRotate = phoneYRotate;
        this.phoneZRotate = phoneZRotate;
    ...
    public NavigationTargetReturn checkForTargets() {
        ...
        if (targetVisible) {
            ...
            return new NavigationTargetReturn(translation, rotation);
        } else {
    ...
    public class NavigationTargetReturn {
        private VectorF translation;
        private Orientation orientation;

        public NavigationTargetReturn(VectorF translation, Orientation orientation) {
